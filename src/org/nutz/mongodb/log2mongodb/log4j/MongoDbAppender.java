 ...
 */
/*
 * Fork form http://log4mongo.googlecode.com/svn/trunk/src/main/java/com/google/code/log4mongo/MongoDbAppender.java
 * @author wendal<wendal1985@gmail.com>
 * 
 */
package org.nutz.mongodb.log2mongodb.log4j;
 ...
 * @see http
 *      ://logging.apache.org/log4j/1.2/apidocs/org/apache/log4j/Appender.html
...
public class MongoDbAppender extends AppenderSkeleton {
	...
	private DBObject bsonifyLoggingEvent(final LoggingEvent loggingEvent) {
		...
		if (loggingEvent != null) {
			...
			result.put("timestamp", new Date(LoggingEvent.getStartTime()));
